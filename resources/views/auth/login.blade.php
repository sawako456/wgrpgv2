  ...
  <div class="row">
    <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
      <form class="form-signin" action="{{ route('auth.login.do') }}" method="POST" accept-charset="UTF-8">
        ...
        <label for="username" class="sr-only">@lang('general.email')</label>
        ...
        <div class="checkbox">
          <label>
            <input type="checkbox" name="remember" value="1" @if(Input::old('remember') == 1) checked @endif> @lang('general.remember_me')
          </label>
        </div>
