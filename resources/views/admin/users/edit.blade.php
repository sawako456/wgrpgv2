          ...
          <div class="card">
            ...
            <div class="card-content">
              ...
              <div class="form-group required @if($errors->has('created_at')) has-error @endif">
                ...
                <input type="text" id="created_at" name="created_at" class="datetime-picker form-control" value="{{ Input::old('created_at', TimeZone::appToLocal($user->created_at)) }}" placeholder="@lang('general.date.created_at')" required>
              </div>
              <div class="form-group required @if($errors->has('updated_at')) has-error @endif">
                <label class="control-label" for="updated_at">@lang('general.date.updated_at')</label>
                <input type="text" id="updated_at" name="updated_at" class="datetime-picker form-control" value="{{ Input::old('updated_at', TimeZone::appToLocal($user->updated_at)) }}" placeholder="@lang('general.date.updated_at')" required>
              </div>
              <div class="form-group">
                <label class="control-label" for="last_login_at">@lang('general.date.last_login_at')</label>
                <input type="text" id="last_login_at" name="last_login_at" class="datetime-picker form-control" value="{{ Input::old('last_login_at', ($user->last_login_at ? TimeZone::appToLocal($user->last_login_at) : null)) }}" placeholder="@lang('general.date.last_login_at')">
              </div>
